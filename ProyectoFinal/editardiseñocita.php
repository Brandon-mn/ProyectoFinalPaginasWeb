...
if (isset($_GET['id'])) {
  ...
  $consulta = "SELECT fecha, hora FROM cita WHERE id_cita = '$idCita'";
    ...
    <div class="row">
      ...
      ?>
          ...
          <div>
            ...
            <form method="POST" action="guardardiseñocita.php">
              ...
              <a href="citatabla.php" class="btn btn-secondary">Cancelar</a>
