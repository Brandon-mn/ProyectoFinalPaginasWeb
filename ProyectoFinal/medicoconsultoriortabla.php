...
$consulta = "SELECT idmedicoconsultorio,id_medico,id_consultorio FROM relacion_medico_consultorio WHERE estatus = 1";
...
while ($fila = mysqli_fetch_assoc($resultados)) {
  ...
  while ($filaPaciente = mysqli_fetch_assoc($resultadoPacientes)) {
    echo '<option value="' . $filaPaciente['id_consultorio'] . '"';
    if ($filaPaciente['id_consultorio'] == $fila['id_consultorio']) {
      echo ' selected';
    }
  ...
  echo '<td>
          <form action="confirmareliminarmedicoconsultorio.php" method="POST">
            <input type="hidden" name="id" value="' . $fila['idmedicoconsultorio'] . '">
            <button type="submit" class="btn btn-danger btn-eliminar">Eliminar</button>
          </form>

          <a href="editardiseñomedicoconsultorio.php?id=' . $fila['idmedicoconsultorio'] . '" class="btn btn-success btn-editar">Editar</a>
        </td>';
...
?>
            ...
            <li class="nav-item">
              <a href="diseñoinsertarmedicoconsultorio.php" class="nav-link">
                <span class="text-black fw-bold btn btn-primary">Agregar</span>
              </a>
              <a href="exportar_pdfmedicoconsultorio.php" target="_blank" class="btn btn-primary">Exportar a PDF</a>
<a href="exportar_xlsmeedicoconsultorio.php" target="_blank" class="btn btn-primary">Exportar a XLS</a>
<a href="exportar_csvmedicoconsultorio.php" target="_blank" class="btn btn-primary">Exportar a CSV</a>
