...
if (isset($_GET['id'])) {
  ...
  $consulta = "SELECT fecha, descripcion FROM historial_medico WHERE id_historial = '$idHisotrial'";
...
?>
          ...
          <div>
            ...
            <form method="POST" action="guardardiseñohistorial.php">
...
<input type="hidden" name="id" value="<?php echo $idHisotrial; ?>">
              <input type="hidden" name="id" value="<?php echo $idHisotrial; ?>">

              <a href="hitorialmedicotabla.php" class="btn btn-secondary">Cancelar</a>
