...
if (isset($_GET['id'])) {
  ...
  $consulta = "SELECT descripcion, duracion, dosis, costo, id_enfermedad FROM tratamiento WHERE id_tratamiento = '$idCita'";
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      $consultaEnfermedades = "SELECT id_enfermedad, nombre FROM enfermedad";
      $resultadoEnfermedades = $conexion->query($consultaEnfermedades);
      ?>
          ...
          <div>
            ...
            <form method="POST" action="guardardiseñotratamiento.php">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="duracion" name="duracion" value="<?php echo $duracion; ?>">
              </div>
              <div class="form-group">
                <label for="hora">dosis:</label>
                <input type="text" class="form-control" id="dosis" name="dosis" value="<?php echo $dosis; ?>">
              </div>
              <div class="form-group">
                <label for="hora">costo:</label>
                <input type="text" class="form-control" id="costo" name="costo" value="<?php echo $costo; ?>">
              </div>
              <div class="form-group">
                <label for="paciente">Enfermedad:</label>
                <select class="form-control" id="enfermedad" name="enfermedad">
                  <?php
                  while ($filaEnfermedad = $resultadoEnfermedades->fetch_assoc()) {
                    $selected = ($filaEnfermedad['id_enfermedad'] == $enfermedad) ? 'selected' : '';
                    echo "<option value='" . $filaEnfermedad['id_enfermedad'] . "' $selected>" . $filaEnfermedad['nombre'] . "</option>";
                  }
                  ?>
                </select>
              </div>
              ...
              <a href="tratamientotabla.php" class="btn btn-secondary">Cancelar</a>
