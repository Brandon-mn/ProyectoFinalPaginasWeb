...
if (isset($_GET['id'])) {
  ...
  $consulta = "SELECT * FROM medico WHERE id_medico = '$idMedico'";
      ...
      <div class="col-md-9">
        ...
        <div class="content">
          ...
          <div>
            ...
            <form method="POST" action="guardardiseñomedico.php">
              ...
              <div class="form-group">
                <label for="direccion">Experiencia:</label>
              ...
              <a href="medicotabla.php" class="btn btn-secondary">Cancelar</a>
