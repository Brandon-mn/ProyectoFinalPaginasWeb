...
$pdf->Cell(40, 10, 'Dirección', 1, 0, 'C');
...
$sql = "SELECT fecha, hora, id_paciente, id_medico FROM cita WHERE estatus = 1";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $pdf->Cell(30, 10, $row['hora'], 1, 0, 'L');
        $pdf->Cell(40, 10, $row['id_paciente'], 1, 0, 'L');
        $pdf->Cell(40, 10, $row['id_medico'], 1, 1, 'L');
    }
} else {
