...
if (isset($_GET['id'])) {
  ...
  $consulta = "SELECT * FROM enfermedad WHERE id_enfermedad  = '$idEnfermedad'";
      ...
      <div class="col-md-9">
        <div class="content">
          ...
          <div>
            ...
            <form method="POST" action="guardardiseñoenfermedad.php">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="sintomas" name="sintomas" value="<?php echo $sintomas; ?>">
              </div>
              <div class="form-group">
                <label for="direccion">Nombre:</label>
                <input type="text" class="form-control" id="gravedad" name="gravedad" value="<?php echo $gravedad; ?>">
              </div>
              <div class="form-group">
                <label for="direccion">Horario:</label>
                <input type="text" class="form-control" id="mortalidad" name="mortalidad" value="<?php echo $mortalidad; ?>">
              </div>
              <input type="hidden" name="id" value="<?php echo $idEnfermedad; ?>">

              <a href="enferemedadtabla.php" class="btn btn-secondary">Cancelar</a>
