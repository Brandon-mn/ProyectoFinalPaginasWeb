...
<body>
  ...
  <div class="content">
    <div id="formulario">
      <form action="agregarenfermedad.php" method="POST">
        ...
        <div class="form-group">
          <label for="telefono">Gravedad:</label>
          <input type="text" class="form-control" id="gravedad" name="gravedad">
        </div>
        <div class="form-group">
          <label for="telefono">Mortailidad:</label>
          <input type="text" class="form-control" id="mortalidad" name="mortalidad">
        </div>
