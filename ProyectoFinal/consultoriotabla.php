...
$consulta = "SELECT id_consultorio, direccion, telefono, nombre, horario FROM consultorio WHERE estatus = 1";
...
while ($fila = mysqli_fetch_assoc($resultados)) {
  ...
  echo '<td>
          <form action="confirmareliminarconsultorio.php" method="POST">
            <input type="hidden" name="id" value="' . $fila['id_consultorio'] . '">
            <button type="submit" class="btn btn-danger btn-eliminar">Eliminar </button>
          </form>

          <a href="editardiseñoconsultorio.php?id=' . $fila['id_consultorio'] . '" class="btn btn-success btn-editar">Editar</a>
        </td>';
  echo "</tr>";
}
...
?>
            ...
            <li class="nav-item">
              <a href="diseñoinsertarconsultorio.php" class="nav-link">
                <span class="text-black fw-bold btn btn-primary">Agregar</span>
              </a>
              <!-- Agrega este código donde deseas mostrar el botón o enlace -->
<a href="exportar_pdf.php" target="_blank" class="btn btn-primary">Exportar a PDF</a>
<a href="exportar_xls.php" target="_blank" class="btn btn-primary">Exportar a XLS</a>
<a href="exportar_csv.php" target="_blank" class="btn btn-primary">Exportar a CSV</a>
<a href="exportar_xlm.php" target="_blank" class="btn btn-primary">Exportar a XLM</a>
<a href="exportar_jason.php" target="_blank" class="btn btn-primary">Exportar a JSON</a>
