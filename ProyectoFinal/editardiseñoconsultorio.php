...
if (isset($_GET['id'])) {
  ...
  $consulta = "SELECT * FROM consultorio WHERE id_consultorio = '$idConsultorio'";
  $resultado = $conn->query($consulta);

  if ($resultado->num_rows > 0) {
    $fila = $resultado->fetch_assoc();

    $direccionConsultorio = $fila['direccion'];
    $telefonoConsultorio = $fila['telefono'];
    $nombre = $fila['nombre'];
      ...
      <div class="col-md-9">
        ...
        <div class="content">
          ...
          <div>
            ...
            <form method="POST" action="guardardiseñoconsultorio.php">
              <div class="form-group">
                <label for="direccion">Dirección:</label>
                <input type="text" class="form-control" id="direccion" name="direccion" value="<?php echo $direccionConsultorio; ?>">
              </div>
              <div class="form-group">
                <label for="telefono">Teléfono:</label>
                <input type="text" class="form-control" id="telefono" name="telefono" value="<?php echo $telefonoConsultorio; ?>">
              </div>
              <div class="form-group">
              ...
              <input type="hidden" name="id" value="<?php echo $idConsultorio; ?>">

              <a href="consultoriotabla.php" class="btn btn-secondary">Cancelar</a>
