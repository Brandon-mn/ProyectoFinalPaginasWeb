...
$consulta = "SELECT id_medico, nombre, apellidos, especialidad, Experiencia FROM medico WHERE estatus = 1";
...
while ($fila = mysqli_fetch_assoc($resultados)) {
  ...
  echo '<td>
          <form action="confirmareliminarmedico.php" method="POST">
            <input type="hidden" name="id" value="' . $fila['id_medico'] . '">
            <button type="submit" class="btn btn-danger btn-eliminar">Eliminar </button>
          </form>

          <a href="editardiseñomedico.php?id=' . $fila['id_medico'] . '" class="btn btn-success btn-editar">Editar</a>
        </td>';
  echo "</tr>";
}
...
?>
            ...
            <li class="nav-item">
              <a href="diseñoagregarmedico.php" class="nav-link">
                <span class="text-black fw-bold btn btn-primary">Agregar</span>
              </a>
              <a href="exportar_pdfmedico.php" target="_blank" class="btn btn-primary">Exportar a PDF</a>
<a href="exportar_xlsmedico.php" target="_blank" class="btn btn-primary">Exportar a XLS</a>
<a href="exportar_csvmedico.php" target="_blank" class="btn btn-primary">Exportar a CSV</a>
<a href="exportar_xlmmedico.php" target="_blank" class="btn btn-primary">Exportar a XLM</a>
<a href="exportar_jasonmedico.php" target="_blank" class="btn btn-primary">Exportar a JSON</a>
            </li>
